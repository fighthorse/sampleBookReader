...
func newCategory(db *gorm.DB, opts ...gen.DOOption) category {
	...
	_category.CategoryDesc = field.NewString(tableName, "category_desc")
	_category.IsDel = field.NewBool(tableName, "is_del")
...
type category struct {
	...
	ParentID     field.Int32  // 父分类
	CategoryDesc field.String // 分类简介
	IsDel        field.Bool   // 是否删除 1 是
...
func (c *category) updateTableName(table string) *category {
	...
	c.CategoryDesc = field.NewString(table, "category_desc")
...
func (c *category) fillFieldMap() {
	...
	c.fieldMap["category_desc"] = c.CategoryDesc
