...
func newGoadminOperationLog(db *gorm.DB, opts ...gen.DOOption) goadminOperationLog {
	_goadminOperationLog := goadminOperationLog{}

	_goadminOperationLog.goadminOperationLogDo.UseDB(db, opts...)
...
func (g goadminOperationLog) Columns(cols ...field.Expr) gen.Columns {
	return g.goadminOperationLogDo.Columns(cols...)
}
...
func (g goadminOperationLog) clone(db *gorm.DB) goadminOperationLog {
	g.goadminOperationLogDo.ReplaceConnPool(db.Statement.ConnPool)
	return g
}

func (g goadminOperationLog) replaceDB(db *gorm.DB) goadminOperationLog {
...
func (g goadminOperationLogDo) Session(config *gorm.Session) *goadminOperationLogDo {
