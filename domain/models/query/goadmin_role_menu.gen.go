...
func newGoadminRoleMenu(db *gorm.DB, opts ...gen.DOOption) goadminRoleMenu {
	_goadminRoleMenu := goadminRoleMenu{}

	_goadminRoleMenu.goadminRoleMenuDo.UseDB(db, opts...)
...
func (g goadminRoleMenu) Columns(cols ...field.Expr) gen.Columns {
	return g.goadminRoleMenuDo.Columns(cols...)
}
...
func (g goadminRoleMenu) clone(db *gorm.DB) goadminRoleMenu {
	g.goadminRoleMenuDo.ReplaceConnPool(db.Statement.ConnPool)
	return g
}

func (g goadminRoleMenu) replaceDB(db *gorm.DB) goadminRoleMenu {
...
func (g goadminRoleMenuDo) ReadDB() *goadminRoleMenuDo {
	return g.Clauses(dbresolver.Read)
}

func (g goadminRoleMenuDo) WriteDB() *goadminRoleMenuDo {
	return g.Clauses(dbresolver.Write)
}

func (g goadminRoleMenuDo) Session(config *gorm.Session) *goadminRoleMenuDo {
...
func (g goadminRoleMenuDo) Returning(value interface{}, columns ...string) *goadminRoleMenuDo {
...
func (g goadminRoleMenuDo) Joins(fields ...field.RelationField) *goadminRoleMenuDo {
...
func (g goadminRoleMenuDo) Preload(fields ...field.RelationField) *goadminRoleMenuDo {
	for _, _f := range fields {
