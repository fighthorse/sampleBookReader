...
func newGoadminMenu(db *gorm.DB, opts ...gen.DOOption) goadminMenu {
	_goadminMenu := goadminMenu{}

	_goadminMenu.goadminMenuDo.UseDB(db, opts...)
...
func (g goadminMenu) Columns(cols ...field.Expr) gen.Columns { return g.goadminMenuDo.Columns(cols...) }
...
func (g goadminMenu) clone(db *gorm.DB) goadminMenu {
	g.goadminMenuDo.ReplaceConnPool(db.Statement.ConnPool)
	return g
}

func (g goadminMenu) replaceDB(db *gorm.DB) goadminMenu {
...
func (g goadminMenuDo) Session(config *gorm.Session) *goadminMenuDo {
