...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.BookID = field.NewInt32(tableName, "book_id")
	_comment.ChapterID = field.NewInt32(tableName, "chapter_id")
	_comment.MemberID = field.NewInt32(tableName, "member_id")
	_comment.CommentDesc = field.NewString(tableName, "comment_desc")
	_comment.CommentLike = field.NewInt32(tableName, "comment_like")
...
type comment struct {
	...
	CommentDesc field.String // 评论内容
	CommentLike field.Int32  // 评论点赞
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.MemberID = field.NewInt32(table, "member_id")
	c.CommentDesc = field.NewString(table, "comment_desc")
	c.CommentLike = field.NewInt32(table, "comment_like")
...
func (c *comment) fillFieldMap() {
	...
	c.fieldMap["comment_desc"] = c.CommentDesc
	c.fieldMap["comment_like"] = c.CommentLike
}
