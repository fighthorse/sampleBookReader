...
func newGoadminSite(db *gorm.DB, opts ...gen.DOOption) goadminSite {
	_goadminSite := goadminSite{}

	_goadminSite.goadminSiteDo.UseDB(db, opts...)
...
func (g goadminSite) Columns(cols ...field.Expr) gen.Columns { return g.goadminSiteDo.Columns(cols...) }
...
func (g goadminSite) clone(db *gorm.DB) goadminSite {
	g.goadminSiteDo.ReplaceConnPool(db.Statement.ConnPool)
	return g
}

func (g goadminSite) replaceDB(db *gorm.DB) goadminSite {
...
func (g goadminSiteDo) Session(config *gorm.Session) *goadminSiteDo {
